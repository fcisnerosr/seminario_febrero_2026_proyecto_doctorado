...
\begin{frame}{Colapso y Dano Estructural Severo}
    \begin{figure}
        \centering
...
\begin{frame}{Perdida de Espesor y Perforacion}
    \begin{figure}
        \centering
        \includegraphics[width=0.75\linewidth]{figs/000_04_dano_real_corrosion.png}
    \end{figure}
\end{frame}
...
\begin{frame}{Proceso de Inspeccion Submarina}
    \begin{figure}
        \centering
        \includegraphics[width=0.75\linewidth]{figs/000_06_actualmente_se_realizan_inspecciones_con_buzos.png}
    \end{figure}
\end{frame}
...
\begin{frame}{Mecanica del Dano: Corrosion Uniforme}
    \begin{columns}
        \column{0.5\textwidth}
        \begin{itemize}
...
\end{frame}\begin{frame}{Caso de Estudio: Propiedades Geométricas}
    \begin{columns}[c]
        \begin{column}{0.5\textwidth}
            ...
            \begin{table}
                ...
                \begin{tabular}{c c c}
                    ...
                    \midrule
                    2.18 & 38.1 & \cellcolor{blue!80} \\
                    1.98 & 38.1 & \cellcolor{violet!80} \\
                    1.57 & 25.4 & \cellcolor{green!80!black} \\
                    1.57 & 25.4 & \cellcolor{red!90} \\
                    \bottomrule
                \end{tabular}
            \end{table}
        \end{column}
...
\begin{frame}{Definición de Niveles de Profundidad}
    \begin{figure}
        \centering
        \includegraphics[width=\linewidth, height=0.8\textheight, keepaspectratio]{./figs/019_niveles_mudline.png}
