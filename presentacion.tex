...
% Seccion 1: Eleccion del Tema
\section{Eleccion del Tema}
\begin{frame}{Eleccion del Tema}
    \begin{itemize}
        \item \textbf{Titulo:} Monitoreo de Salud Estructural (SHM) basado en optimizacion inversa para la identificacion de daño en plataformas tipo Jacket.
        \item \textbf{Enfoque:} Desarrollo de una metodologia no destructiva basada en vibraciones y algoritmos geneticos (AG).
        \item \textbf{Innovacion:} Introduccion del Indice de Calidad de Deteccion (ICD) para mitigar la incertidumbre en entornos ruidosos.
    \end{itemize}
\end{frame}
...
\begin{frame}{Justificacion del Problema}
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \item \textbf{Necesidad:} Estrategias de mantenimiento predictivo basadas en datos (SHM).
        \end{itemize}
...
\begin{frame}{Optimizacion con Algoritmos Geneticos}
    \begin{columns}
        \column{0.5\textwidth}
        \begin{itemize}
            \item \textbf{Problema Inverso:} Ajuste de modelo para coincidir con respuesta medida.
            \item \textbf{Busqueda Global:} AG robustos ante minimos locales.
            \item \textbf{Funcion Objetivo:} Minimizacion del error entre modelo y realidad (o simulacion dañada).
        \end{itemize}
        
        \column{0.5\textwidth}
        \begin{figure}
            \includegraphics[width=\linewidth]{006_metodología_del_AG_para_localizar_daños_a_nivel_computacional.jpg}
            \caption{Flujo del Algoritmo Genetico.}
        \end{figure}
    \end{columns}
\end{frame}

\begin{frame}{Funcionamiento del AG y Metrica}
    \begin{figure}
        \centering
        \includegraphics[width=0.65\linewidth]{015_diagrama_como_funciona_el_AG_para_la_sumas_funcion_P_y_como_se_relaciona_con_operadores_geneticos_del_AG.jpg}
        \caption{Operadores geneticos y evaluacion de la funcion objetivo (ICD).}
    \end{figure}
\end{frame}
...
\begin{frame}
    \centering
    \Huge \textbf{Gracias por su atencion}
\end{frame}
